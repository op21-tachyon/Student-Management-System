...
<body>
	<div id="header"><br>
		<h3><center>Student Management System &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $_SESSION['email'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:<?php echo $_SESSION['name'];?> 
		<a href="logout.php">Logout</a></center></h3>
		</center>
	</div>
	...
	<div id="left_side">
		...
		<form action="" method="post">
			<table>
				<tr>
					<td>
						<h6><input type="submit" name="search_student" value="Search Student"></h6>
					</td>
				</tr>
				<tr>
					<td>
						<h6><input type="submit" name="edit_student" value="Edit Student"></h6>
					</td>
				</tr>
				<tr>
					<td>
						<h6><input type="submit" name="add_new_student" value="Add New Student"></h6>
					</td>
				</tr>
				<tr>
					<td>
						<h6><input type="submit" name="delete_student" value="Delete Student"></h6>
					</td>
				</tr>
				<tr>
					<td>
						<h6><input type="submit" name="show teacher" value="Show Teachers"></h6>
					</td>
				</tr>
			</table>
		</form>
